  ...
  return (
    <div className="px-6 lg:px-10 py-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="mt-2 font-display text-3xl font-bold tracking-tight">Generate a new script</h1>
        <p className="mt-1 text-muted-foreground">Tell us your niche, platform, and tone. We'll write the hook, body, CTA, and hashtags — platform-native.</p>
      </div>
      <NewScriptForm />
    </div>
  );
