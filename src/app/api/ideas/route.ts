...
const GenerateSchema = z.object({
  ...
  // If true (default), generate via AI. If false, return saved ideas only.
  generate: z.boolean().default(true),
});

// POST — generate ideas via Z.AI and persist them to the user's idea bank
export async function POST(req: Request) {
  try {
    ...
    // Persist all generated ideas to DB with status "idea"
...
// GET — list user's saved ideas, optionally filtered by status
