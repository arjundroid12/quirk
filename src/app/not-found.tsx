      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="text-center max-w-md">
          ...
          <div className="relative inline-block">
            <div
              className="font-display text-[120px] sm:text-[180px] font-bold leading-none brand-gradient-text"
              aria-hidden="true"
            >
              404
            </div>
          ...
          <p className="mt-3 text-muted-foreground">
            Let's get you back to creating. The page you're looking for doesn't exist — but your next great script, idea, or thumbnail is one click away.
          </p>
